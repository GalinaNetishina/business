...
def upgrade() -> None:
    ...
    op.create_index('ix_positions_path', 'position', ['path'], unique=False, postgresql_using='gist')
    op.create_table('structure',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('company_id', sa.UUID(), nullable=True),
    sa.Column('positions', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['company.id'], ),
    sa.ForeignKeyConstraint(['positions'], ['position.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('importance', sa.Enum('TOP', 'MIDDLE', 'STANDARD', name='priorities'), server_default=sa.text("'STANDARD'"), nullable=False),
    sa.Column('status', sa.Enum('CREATED', 'IN_WORK', 'ON_MODERATION', 'CANCELED', 'DONE', name='statuses'), server_default=sa.text("'CREATED'"), nullable=False),
    sa.Column('details', sa.String(), nullable=True),
    sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=False),
    sa.Column('start_data', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', now())"), nullable=False),
    sa.Column('update_data', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', now())"), nullable=False),
